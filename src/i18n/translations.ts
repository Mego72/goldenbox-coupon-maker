...
export const translations = {
  ar: {
    ...
    loadAll: "تحميل الكل",
    selectFilterFirst: "اختر فلتر ثم اضغط تحميل البيانات، أو اضغط تحميل الكل",
    ...
    billTo: "فاتورة إلى",
    itemDescription: "البيان",
    unitPrice: "سعر الوحدة",
    amount: "المبلغ",
    subtotal: "المجموع الفرعي",
    totalDue: "المبلغ المستحق",
    couponUsageCharges: "رسوم استخدام الكوبونات",
    invoiceNote: "هذه فاتورة مبدئية لرسوم استخدام كوبونات الخصم المستهلكة خلال الفترة المحددة.",
  ...
  en: {
    ...
    loadData: "Load Data",
    loadAll: "Load All",
    selectFilterFirst: "Select a filter then click Load Data, or click Load All",
    ...
    subtotal: "Subtotal",
    totalDue: "Total Due",
    couponUsageCharges: "Coupon Usage Charges",
    invoiceNote: "This is a proforma invoice for discount coupon usage charges consumed during the specified period.",
